...
setup(
    ...
    install_requires=[
        ...
        "plone.app.vocabularies.catalog.StaticCatalogVocabulary",
        "plone.autoform.directives",
        "plone.autoform.interfaces.IFormFieldProvider",
    ...
    extras_require={
        "test": [
            ...
            "pytest-cov",
            "pytest-plone>=0.5.0",
            "plone.app.contenttypes.testing.PLONE_APP_CONTENTTYPES_FIXTURE",
